export const newcomptrollerabi = [
  {
    inputs: [
      { internalType: "address", name: "poolRegistry_", type: "address" },
    ],
  ...
  { inputs: [], name: "ComptrollerMismatch", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "collateralToSeize", type: "uint256" },
  ...
  { inputs: [], name: "InvalidLiquidationThreshold", type: "error" },
  {
  ...
  {
    inputs: [
      { internalType: "uint256", name: "expectedGreaterThan", type: "uint256" },
      { internalType: "uint256", name: "actual", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "loopLimit", type: "uint256" },
      {
        internalType: "address",
        name: "accessControlManager",
        type: "address",
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "error", type: "uint256" },
      { internalType: "uint256", name: "tokensToSeize", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "vTokenCollateral", type: "address" },
      { internalType: "address", name: "seizerContract", type: "address" },
      { internalType: "address", name: "liquidator", type: "address" },
      { internalType: "address", name: "borrower", type: "address" },
    ],
    name: "preSeizeHook",
  ...
  {
    inputs: [
      { internalType: "contract IPrime", name: "_prime", type: "address" },
    ],
    name: "setPrimeToken",
    outputs: [],
    stateMutability: "nonpayable",
...
export const oldecomptrollerabi = [
  {
    anonymous: false,
    inputs: [
      {
